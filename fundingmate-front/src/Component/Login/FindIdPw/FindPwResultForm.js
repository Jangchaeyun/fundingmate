...
function FindPwResultForm(props) {
    ...
    const submit = (e) => {
        ...
        if(user.password == "") {
            ...
            alert("비밀번호는 8~16자의 영문 대/소문자, 숫자, 특수문자를 조합하여 입력해주세요 !");
            document.getElementById("password").focus();
            return
        ...
        <div className="findPwResultform">
            ...
            <div className="findwrap">
                <form onSubmit={submit}>
                    ...
                    <div className="findwrap">
                            <input type="password" name="password" id="password" placeholder="새 비밀번호(8~16자의 영문 대/소문자, 숫자, 특수문자)" onChange={changeInput} autocomplete="off"/>
                            <input type="password" name="passwordRe" id="passwordRe" placeholder="비밀번호 확인" onChange={changeInput} autocomplete="off"/>
                    </div>
