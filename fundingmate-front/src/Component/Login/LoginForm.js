...
function LoginForm(props) {
    ...
    return (
        <div className="loginForm">
            <form onSubmit={login}>
                <input type="text" name="id" id="id" value={id} onInput={(e)=>{setId(e.target.value)}} required placeholder="아이디" className="loginIp" autocomplete='off'/>
                <br/>
                <input type="password" name="password" value={password} onInput={(e)=>{setPassword(e.target.value)}} required placeholder="비밀번호" className="loginIp"/>
                <br/>
                <div className="keepSearch">
                    <label for="keep" className="keepChkLb"><input type="checkbox" name="" id="keep" className="keepChk" checked={rememberMe} onChange={(e) => setRememberMe(e.target.checked)}/>로그인 상태 유지</label>
                    <a href="findIdPw" className="idPwSearch">아이디 비밀번호 찾기 <RightOutlined /></a>
                </div>
                <input type="submit" value="로그인" className="loginBtn" />
            </form>
            <div className="socialLogin">
                <button className="googleLogin"><img  src={require("../../assets/images/Login/googleIcon.png")} />구글 로그인</button><br/>
                <button className="naverLogin"><img  src={require("../../assets/images/Login/naverIcon.png")} />네이버 로그인</button><br/>
                <button className="kakaoLogin" onClick={kakaoLogin }><img  src={require("../../assets/images/Login/kakaoIcon.png")} />카카오 로그인</button>
            </div>
            <div className="join">
