...
const MakeReward4 = () => {
    ...
    return (
        ...
        <div className="investMake-wrapper">
            ...
            <textarea type="text" name="rewardRefundExchangePolicy" className="rew-textarea" placeholder="환불 및 교환 정책 외에 추가사항이 있으시면 적어주세요." value={totInfo.rewardRefundExchangePolicy} onChange={handleInputChange}/>
            ...
            <input type="text" name="rewardContact" className="input-box" value={totInfo.rewardContact} onChange={handleInputChange}/>
            ...
            <input type="text" name="rewardEmail" className="input-box" value={totInfo.rewardEmail} onChange={handleInputChange}/>
            ...
            <textarea type="text" name="modelName" defaultValue={totInfo.modelName} className="rew-textarea"  placeholder="내용을 입력하세요." style={{width:"99%", height:"90px"}} onChange={handleInputChange}/>
            <br/>
            <br/>
            <p style={{fontSize:"15px"}}><b>법에 의한 인증·허가 등을 받았음을 확인할 수 있는 경우 그에 대한 사항</b></p>
            <textarea type="text" name="rewardLaw" defaultValue={totInfo.rewardLaw} className="rew-textarea"  placeholder="내용을 입력하세요." style={{width:"99%", height:"90px"}} onChange={handleInputChange}/>
            <br/>
            <br/>
            <p style={{fontSize:"15px"}}><b>제조국 또는 원산지</b></p>
            <textarea type="text" name="countryOfOrigin" defaultValue={totInfo.countryOfOrigin} className="rew-textarea"  placeholder="내용을 입력하세요." style={{width:"99%", height:"90px"}} onChange={handleInputChange}/>

            <br/>
            <br/>
            <p style={{fontSize:"15px"}}><b>제조자(수입자)</b></p>
            <textarea type="text" name="manufacturer" defaultValue={totInfo.manufacturer} className="rew-textarea"  placeholder="내용을 입력하세요." style={{width:"99%", height:"90px"}} onChange={handleInputChange}/>

            <br/>
            <br/>
            <p style={{fontSize:"15px"}}><b>AS 책임자와 전화번호 또는 소비자상담 관련 전화번호</b></p>
            <textarea type="text" name="asPhonenumber" defaultValue={totInfo.asPhonenumber} className="rew-textarea"  placeholder="내용을 입력하세요." style={{width:"99%", height:"90px"}} onChange={handleInputChange}/>
