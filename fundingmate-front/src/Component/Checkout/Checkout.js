    ...
    <div>
      ...
      <form>
        ...
        <div className="phone">
          ...
          <button type="submit" className="num_auth">인증</button>
        </div>
        ...
        <div className="card_date">
          <input type="text" className="card_date_yy_mm" placeholder="MM" required/>
          <input type="text" className="card_date_yy_mm" placeholder="YY" required/>
        </div>
        <p className="title">생년월일</p>
        <input type="text" className="birthday" placeholder="법인 카드의 경우 사업자 등록번호 10자리 숫자" required/>
        ...
        <div className="check_box">
          <label className="check_title"><input type="checkbox" className="check" required/> [필수] 결제에 필요한 정보 제공에 동의합니다.</label>
          <br/>
