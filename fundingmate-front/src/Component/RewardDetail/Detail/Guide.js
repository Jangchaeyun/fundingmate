    ...
    <div>
      ...
      <div className="menu">
        ...
        <div className="menu_items">
          ...
          <Link className="guide active" to={"/reward-detail/guide"}>
            안내
          </Link>
        </div>
      </div>
      <div className="guide_infos">
        ...
        <p className="guide_content">
          ...
          <br />
          -참여자의 책임 있는 사유로 리워드가 멸실/훼손된 경우(단지 확인을 위한
          포장 훼손 제외) -참여자의 사용/소비에 의해 리워드의 가치가 감소한 경우
          <br />
        ...
        <p className="guide_content">
          - 주소 변경은 프로젝트 종료 전까지만 마이페이지의 펀딩한 프로젝트에서
          할 수 있습니다.
